# Contributing to go-encryptor

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to `go-encryptor`, which are hosted in the [mrinjamul/go-encryptor](https://github.com/mrinjamul/go-encryptor) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
